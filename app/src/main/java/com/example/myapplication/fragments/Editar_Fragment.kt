...
class Editar_Fragment : Fragment() {
    ...
    sharedPreference = requireActivity().getSharedPreferences("UserData", Context.MODE_PRIVATE)
        ...
        Editnombres_perfil = view.findViewById(R.id.Editnombres_perfil);
        Editapellido_perfil= view.findViewById(R.id.Editapellido_perfil);
        Editcorreo_perfil=view.findViewById(R.id.Editcorreo_perfil);
        Edittelefono_perfil=view.findViewById(R.id.Edittelefono_perfil);
        ...
        btnGuardarInfo_editperfil = view.findViewById(R.id.btnGuardarInfo_editperfil)
        btnGuardarInfo_editperfil.setOnClickListener{
            Editardatos()
            Toast.makeText(requireContext(), "Datos guardados", Toast.LENGTH_SHORT).show()
            findNavController(this).navigate(R.id.perfilFragment)
        }
